...
namespace SF {
  ...
  protected:
    ...
    std::vector<KeyValueList*>  values;  //each is a collection of named-uservalues...
  ...
  public:
    ...
    virtual   ~InsertStatement();
              ...
              StatusResult  parseValues(Parser &aParser, Schema &aSchema);
    ...
    virtual   StatusResult  validate(Schema &aSchema) const;
              ...
              KeyValueList* getValueGroupAt(int anIndex);
  };
